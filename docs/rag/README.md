...
- [`../RAG_TEST_PLAN.md`](../RAG_TEST_PLAN.md) — local unit, MCP smoke, RAG quality, full PDF, and Railway write-gate tests.
...
- Change MCP tools or the Rust renderer → run `../RAG_TEST_PLAN.md` before declaring the change done.
